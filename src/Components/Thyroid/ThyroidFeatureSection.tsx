...
import thyroidFeaturesImage from "@/assets/thyroid/THYROID-BANNER-2-475x530.jpg";
import { SiGotomeeting } from "react-icons/si";


const ThyroidFeaturesSection = () => {
  const features = [
    {
      Image: <SiGotomeeting />,
      title: "Acne",
...
export default ThyroidFeaturesSection;
