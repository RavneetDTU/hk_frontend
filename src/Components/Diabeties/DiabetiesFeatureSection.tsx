...
import DiabetiesFeaturesImage from "@/assets/diabetes/DIABETES-BANNER-2-475x530.jpg";
import { SiGotomeeting } from "react-icons/si";


const DiabetiesFeaturesSection = () => {
  const features = [
    {
      Image: <SiGotomeeting />,
      title: "Acne",
...
export default DiabetiesFeaturesSection;
